...
def sequence_to_true_signal(input_part, output_folder, perfect=False, p_len=1,
    ...
    #--- get kmer signal ----#
    kmer_poremodel = load_official_poremodel('module/simulateNanoSigs/module/generate_nanoTruesig/model_data/template_median68pA.model')
...
def get_parameters():
    ...
    parser.add_argument('-o', type=str, required=True,
                        help='output folder, the output signals in here.')

    parser.add_argument('-rootName', type=str, required=False, default = "timeSeries", 
                        help='The root name of simulated 6-mer nanpore signal files.')

    parser.add_argument('-seed', type=int, required=False, default = 0, 
                        help='Random seed used to control the noise of the simulation.')
...
def main():
    ...
    for seq in zip_id_seq:
        sequence_to_true_signal(seq, output_folder=args.o, sigroot=args.rootName, seed=args.seed)
